        ...
        groups: [
            ...
            },
            {
                ...
                steps: [
                    ...
                    'Work Programme — eksport view MS Project (Gantt Chart) ke Excel (lajur Task Name, Duration, Start, Finish, % Complete, dan jika ada [Plan %], [Outline Level]), klik "Import Excel", padankan lajur mengikut medan yang diperlukan (Task name wajib), semak sampel data, isi label dan tarikh status, kemudian klik "Import". Atau simpan program kerja sebagai fail MS Project XML (MSPDI) dan klik "Import MS Project XML". Versi yang ditanda "Current" digunakan sebagai jadual aktiviti dalam seksyen 2.5 laporan bulanan; versi lama boleh dilihat, ditanda semula sebagai current, dinamakan semula atau dipadam.',
            ...
            },
            {
                ...
                steps: [
                    ...
                    'Carta S-curve bagi seksyen 2.2 (fizikal) dan 2.4 (kewangan) dijana secara automatik daripada data sistem — tiada butang "refresh" berasingan; carta dikemas kini bila seksyen di-regenerate atau data sumber berubah.',
                    'Seksyen 2.2/2.4 — muat naik carta S-curve sebagai PNG/JPG/PDF (seperti halaman Gantt 2.5); jika tiada muat naik, sistem jana carta automatik.',
                    'Seksyen 4.3 (cuaca) memaparkan grid 24 jam bagi setiap hari dalam tempoh laporan.',
                    'Klik butang "Layout" untuk pilih seksyen yang dipaparkan dalam orientasi landscape (lalai: 2.2, 2.3, 2.4, 2.5, 4.1, 4.2). Klik "Reset to defaults" untuk kembali kepada set lalai.',
                    'Seksyen 2.5 (Program Kerja / Gantt) memaparkan jadual aktiviti daripada versi program kerja "Current" yang diimport dalam Report Data > Work Programme (baris ibu/summary dipaparkan tebal, mengikut aras outline); editor hanya memaparkan 100 baris pertama, jadual penuh disertakan dalam eksport PDF/Word. Di bawah jadual, muat naik halaman carta Gantt dari MS Project sebagai PDF atau imej PNG/JPG. Jika muat naik PDF ditolak dengan ralat "compression", simpan semula fail sebagai PDF versi 1.4 (atau guna "Print to PDF") sebelum cuba lagi, atau muat naik sebagai PNG.',
                    'Halaman Gantt yang dimuat naik dilampirkan pada PDF laporan sejurus selepas seksyen 2.5, dan seksyen 2.5 automatik diaktifkan (include) apabila halaman pertama dimuat naik. Halaman boleh disusun semula atau dipadam; penomboran muka surat PDF ("Page X of Y") berterusan merentasi semua halaman termasuk halaman Gantt.',
                    'Badge oren "changed" di sebelah nama seksyen bermaksud data sistem telah dijana semula (regenerate) selepas suntingan anda pada seksyen itu — suntingan anda masih dikekalkan. Pilih "Use system data" untuk buang suntingan dan guna data sistem terkini, atau "Keep my edits" untuk kekalkan suntingan anda dan abaikan amaran.',
                    'Jika seksyen memaparkan kad kelabu "No data yet — enter it under …", klik pautan di dalam kad untuk pergi terus ke tempat data sepatutnya dimasukkan (cth. Report Data > Progress & Baseline), isi data di sana, kembali ke laporan dan klik "Regenerate this section".',
                    'Klik "Export PDF" untuk jana PDF laporan bulanan penuh.',
                    'Klik butang "Export Word" untuk muat turun laporan sebagai fail .docx yang boleh disunting. Carta S-curve bagi seksyen 2.2 dan 2.4 dirakam secara automatik (sebagai imej) sejurus sebelum muat turun bermula; untuk laporan yang telah *finalise*, rakaman carta terakhir yang tersedia digunakan.',
                    'Selepas buka fail Word, Word mungkin bertanya "This document contains fields that may refer to other files. Do you want to update the fields in this document?" atau ringkasnya "Update fields?" — klik "Yes" supaya jadual Isi Kandungan dikemas kini dengan nombor muka surat yang betul. Jika Word tidak bertanya secara automatik, kandungan Isi Kandungan mungkin tidak lengkap — klik kanan atasnya dan pilih "Update Field" (atau tekan F9) untuk kemas kini secara manual.',
                    'Halaman carta Gantt yang dimuat naik sebagai PDF (seksyen 2.5) disenaraikan dalam eksport Word sebagai lampiran sahaja (fail PDF tidak boleh dibenamkan terus dalam Word); jika mahu halaman Gantt dipaparkan terus dalam dokumen Word, muat naik sebagai imej PNG/JPG sebaliknya.',
                    'Semua jadual dalam fail Word boleh disunting bebas selepas dimuat turun.',
                    'Pautan "Word" pada senarai laporan (halaman "Monthly Reports") memuat turun terus tanpa merakam carta baharu — ia menggunakan rakaman carta sedia ada (jika ada); buka laporan dan klik "Export Word" di dalam editor untuk rakaman carta terkini.',
