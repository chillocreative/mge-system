...
import { HiOutlineUserGroup, HiOutlinePlus, HiOutlinePencil, HiOutlineTrash, HiOutlineLockClosed, HiOutlineSearch } from 'react-icons/hi';
    ...
    const fetchUsers = useCallback((page = 1, searchTerm = search) => {
        ...
        apiClient.get('/users', { params })
            .then((res) => {
                ...
                setPagination(paginated.meta || { current_page: 1, last_page: 1, total: 0 });
            })
            .catch(() => setUsers([]))
        ...
        <div>
            ...
            {!loading && users.length > 0 && (
                <div className="mt-4 flex items-center justify-between text-sm text-gray-500">
                    <span>Page {pagination.current_page || 1} of {pagination.last_page || 1} · {pagination.total || 0} users</span>
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => fetchUsers((pagination.current_page || 1) - 1)}
