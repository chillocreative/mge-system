                                        ...
                                        <ul className="divide-y divide-gray-100 rounded-lg border border-gray-200">
                                            {attachments.map((f) => (
                                                <li key={f.id} className="flex items-center justify-between gap-3 px-3 py-2 text-sm">
                                                    ...
                                                    <a href={`/api/safety/hirarc/${form.id}/attachments/${f.id}/download`} target="_blank" rel="noopener" className="shrink-0 text-xs font-medium text-primary-600 hover:text-primary-700">Download</a>
                                                </li>
                                            ))}
                                        </ul>
                                    )}
